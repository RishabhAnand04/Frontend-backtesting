  ...
  const options = {
    ...
    body: JSON.stringify({
      ...
      indicators: [
        ...
        {
          indicatorType: "EMA",
          indicatorName: "lessGo",
          length: "12",
          indicatorString: "ta.ema(close,12)",
        },
      ],
      entry_conditions: {
        Ind1: ["ta.ema(close,12)"],
        ops: ["crossAbove"],
        Ind2: ["ta.tsi(close,12,14,15)[ta.tsi(close,12,14,15).keys()[0]]"],
        cand1: ["2"],
        cand2: ["3"],
        andOr: ["-"],
      },
      exit_conditions: {
        Ind1: ["ta.tsi(close,12,14,15)[ta.tsi(close,12,14,15).keys()[0]]"],
        ops: ["=="],
        Ind2: ["ta.rsi(close,12)"],
        cand1: ["4"],
        cand2: ["8"],
        andOr: ["-"],
      },
